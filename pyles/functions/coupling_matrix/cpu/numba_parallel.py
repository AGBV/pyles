...
def particle_interaction(lmax: int, particle_number: int, idx: np.ndarray, x: np.ndarray, wx: np.ndarray, translation_table: np.ndarray, plm: np.ndarray, sph_h: np.ndarray, e_j_dm_phi):
