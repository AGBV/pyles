...
class TestOptics(unittest.TestCase):
  ...
  #   np.set_printoptions(precision=8, edgeitems=3, linewidth=np.inf)
  ...
  def test_phase_function(self):
    ...
    for data_file in glob.glob('tests/data/%s_*.mat' % module):
      ...
      np.testing.assert_allclose(phase_function,  phase_function_test, relative_precision,  0, True, 'The extinction efficiencies do not match.')
